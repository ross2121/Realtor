...
const BlogSubscribe = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch bg-gray-300 flex flex-col items-center justify-start py-[120px] px-5 box-border gap-[60px] max-w-full text-left text-17xl text-white font-manrope lg:pt-[78px] lg:pb-[78px] lg:box-border mq750:gap-[30px] mq750:pt-[51px] mq750:pb-[51px] mq750:box-border ${className}`}
    >
      <div className="w-[1200px] flex flex-row flex-wrap items-start justify-center gap-[20px] max-w-full">
        ...
        <div className="flex flex-col items-start justify-start pt-[13.5px] px-0 pb-0 text-lg text-orangered">
          <div className="flex flex-row items-start justify-start gap-[8px]">
            <div className="flex flex-col items-start justify-start pt-[3px] px-0 pb-0">
              <b className="relative leading-[18px] font-bold inline-block min-w-[92px]">
                Explore All
              </b>
            </div>
            <img
      ...
      <div className="w-[1200px] flex flex-col items-start justify-start gap-[120px] max-w-full text-5xl lg:gap-[60px] mq750:gap-[30px]">
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[24px] max-w-full">
          <div className="flex-1 flex flex-col items-start justify-start gap-[24px] min-w-[288px] max-w-full">
        ...
        <div className="self-stretch rounded-3xs bg-silver-300 flex flex-col items-center justify-center py-10 px-0 box-border max-w-full text-9xl text-gray-300">
          <div className="w-[1000px] flex flex-col items-center justify-start py-0 px-5 box-border gap-[30px] max-w-full">
            <div className="w-[600px] flex flex-col items-center justify-start gap-[10px] max-w-full">
              <h2 className="m-0 relative text-inherit tracking-[-0.56px] leading-[38px] font-extrabold font-inherit inline-block max-w-full mq450:text-3xl mq450:leading-[30px]">
                For Recent Update, News.
              </h2>
              <p className="m-0 self-stretch relative text-lg leading-[32.4px] text-center">
            ...
            <div className="w-[600px] flex flex-row flex-wrap items-start justify-start gap-[8px] max-w-full">
              ...
              <button className="cursor-pointer [border:none] py-4 px-6 bg-gray-300 rounded-3xs flex flex-row items-start justify-start hover:bg-dimgray-300">
                <b className="relative text-base leading-[16px] font-semibold font-manrope text-white text-left inline-block min-w-[78px]">
                  Subscribe
                </b>
              </button>
            </div>
